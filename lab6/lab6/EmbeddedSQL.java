...
public class EmbeddedSQL {
   ...
   public static void Query1(EmbeddedSQL esql){
      // Your code goes here.
      try{
         String query = "SELECT S.sname, COUNT(*) as partCount FROM suppliers S, catalog C, parts P WHERE (P.pid = C.pid) AND (S.sid = C.sid) GROUP BY S.sid;";
   ...
   public static void Query2(EmbeddedSQL esql){
      // Your code goes here.
      try{
         String query = "SELECT S.sname, COUNT(*) as partCount FROM suppliers S, catalog C, parts P WHERE (P.pid = C.pid) AND (S.sid = C.sid) GROUP BY S.sid HAVING 2 < (SELECT COUNT(*) FROM Suppliers S2, catalog C2, parts P2 WHERE (P2.pid = C2.pid) AND (S2.sid = C2.sid) AND (S.sid = S2.sid));";
   ...
   public static void Query3(EmbeddedSQL esql){
      // Your code goes here.
      try{
         String query = "SELECT S.sname, COUNT(*) as partCount FROM suppliers S, catalog C, parts P WHERE (P.pid = C.pid) AND (S.sid = C.sid) GROUP BY S.sid HAVING EVERY(P.color = 'Green');";
   ...
   public static void Query4(EmbeddedSQL esql){
      // Your code goes here.
      try{
	 String query = "SELECT S.sname, MAX(C.cost) FROM suppliers S, catalog C, parts P, (SELECT S.sid, S.sname FROM suppliers S, catalog C, parts P WHERE (P.pid = C.pid) AND (S.sid = C.sid) AND (P.color = 'Red') GROUP BY S.sid INTERSECT SELECT S2.sid, S2.sname FROM suppliers S2, catalog C2, parts P2 WHERE (P2.pid = C2.pid) AND (S2.sid = C2.sid) AND (P2.color = 'Green') GROUP BY S2.sid) rgsupplier WHERE (S.sid = C.sid) AND (rgsupplier.sid = C.sid) AND (P.pid = C.pid) GROUP BY S.sid;";
   ...
   public static void Query6(EmbeddedSQL esql){
      // Your code goes here.
      try{
         String query = "SELECT S.address FROM suppliers S, catalog C, parts P WHERE (P.pid = C.pid) AND (S.sid = C.sid) AND (P.pname = '";
